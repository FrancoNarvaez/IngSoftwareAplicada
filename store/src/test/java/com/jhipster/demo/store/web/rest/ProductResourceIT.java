...
import static com.jhipster.demo.store.domain.ProductAsserts.*;
...
class ProductResourceIT {
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).productSize(UPDATED_PRODUCT_SIZE);
