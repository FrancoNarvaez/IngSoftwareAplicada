...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'boastfully debut', price: 15856.9, productSize: 'S' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('furthermore quintuple for');
      cy.get(`[data-cy="name"]`).should('have.value', 'furthermore quintuple for');

      cy.get(`[data-cy="description"]`).type('insidious');
      cy.get(`[data-cy="description"]`).should('have.value', 'insidious');

      cy.get(`[data-cy="price"]`).type('19946.31');
      cy.get(`[data-cy="price"]`).should('have.value', '19946.31');
